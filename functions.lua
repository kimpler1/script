-- functions.lua: Loader с базовым GUI для немедленного отображения
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Dead Rails Ultimate GUI by Grok", "BloodTheme")

-- Базовые табы и секции (GUI видим сразу)
...
-- Подгрузка частей (они добавят кнопки и функции)
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "GUI Loaded",
    Text = "Функции добавлены, GUI готов!",
    Duration = 5
})
